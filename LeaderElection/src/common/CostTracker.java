...
/**
 * An object shared by all the threads which tracks the costs of various parts of the simulation
 */
...
public class CostTracker {
	...
	/**
	 * What stage of the simulation we are in, as we track cost for them separately
	 * Either we are incurring costs in the election of the leader, a broadcast from the 
	 * leader, or a query to the leader
	 *
	 */
	public enum Stage {
	 ...
	 * We store the costs by the process that's recording them so as to further ensure
	 * no race conditions
	 */
	 ...
	 * 
	 * @param ids		The ids of the various processes
	 * @param outfile	The outfile where things should be written
	 */
	 ...
	 * 
	 * @param s 			The stage we are in
	 * @param processID		The processID registering this cost
	 * @param cost			The cost to be registered
	 */
